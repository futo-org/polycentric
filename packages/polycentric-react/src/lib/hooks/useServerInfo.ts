...
export function useServerInfo(serverUrl: string | null | undefined): UseServerInfoResult {
            ...
            try {
                ...
                if (!response.ok) {
                    ...
                    if (response.status === 404) {
                        ...
                        console.warn(`Server info endpoint not found at ${apiUrl}. Using URL as name.`);
                    } else {
