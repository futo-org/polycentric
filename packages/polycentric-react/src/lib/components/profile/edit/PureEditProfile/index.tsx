...
const InnerPureEditProfile = ({
  ...
  const { avatarValidAndChanged, descriptionValidAndChanged, usernameValidAndChanged, validAndChanged } =
    useMemo(() => {
      ...
      return {
        validAndChanged: usernameValidAndChanged || descriptionValidAndChanged || avatarValidAndChanged,
  ...
  useEffect(() => setTitle(`${displayUsername}'s profile`), [displayUsername, setTitle])
...
export const PureEditProfile = ({
  ...
  return (
    ...
    <Modal title={title} open={open} setOpen={setOpen}>
      <InnerPureEditProfile profile={profile} actions={actions} open={open} setOpen={setOpen} setTitle={setTitle} />
    </Modal>
  )
}
