      ...
      <div className="flex relative overflow-clip">
        ...
        <div className="flex-grow min-w-0">
          <div className="flex w-full justify-between">
            <div className="font-bold text-md w-full overflow-hidden text-ellipsis">{main.author.name}</div>
            {/* <div className="pr-3 md:pr-0 font-light text-gray-500">{dateToAgoString(main.publishedAt)}</div> */}
          </div>
          <div className=" text-purple-400 w-full overflow-hidden text-ellipsis">{main.topic}</div>
