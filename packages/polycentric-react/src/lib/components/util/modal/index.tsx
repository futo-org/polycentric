    ...
    <Transition appear show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={() => setOpen(false)}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-gray-100 bg-opacity-30" onClick={() => setOpen(false)} />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel
                className={
                  'transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle border transition-all' +
                  desktopClassName
                }
              >
