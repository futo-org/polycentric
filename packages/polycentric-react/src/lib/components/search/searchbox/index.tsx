    ...
    <div className="flex flex-col space-y-2">
      <div className="flex rounded-full border focus-within:border-gray-300 p-2 space-x-2">
        <input
          type="text"
          placeholder="Search..."
          className="flex-grow text-lg ml-4 placeholder:font-light placeholder:text-gray-300 text-gray-800 focus:outline-none min-w-0 bg-transparent"
          value={query}
        ...
        >
          <ArrowRightIcon
            className={`w-6 h-6  ${
              query.length >= 3 ? 'text-gray-500' : 'text-gray-300'
            }`}
          />
        </Link>
      </div>
