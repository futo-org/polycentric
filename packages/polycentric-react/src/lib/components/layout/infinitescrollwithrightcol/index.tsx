...
export const InfiniteScrollWithRightCol = ({
  ...
  return (
    <div
      ...
      className="h-full flex overflow-y-scroll noscrollbar bg-white"
    ...
    >
          ...
          <Virtuoso
            ...
            itemContent={(index, data) => (
              <Post
                ...
                autoExpand={
                  prependCount !== undefined && index === 100 - prependCount
                }
                data={data}
              />
            )}
            ...
            components={{
              Header: topFeedComponentSticky === false ? Header : undefined,
      ...
      {isMobile === false && (
        <>
          ...
          <RightCol verticalIpadExpanded={verticalIpadExpanded} key="rightcol">
            {rightCol}
          </RightCol>
        </>
      )}
